...
public partial class AdminMedicalRecordsView : UserControl
{
    private readonly HospitalDataService _dataService = HospitalDataService.Instance;
    private bool _isInitialized;

    public AdminMedicalRecordsView(UserAccount? currentUser)
    {
        InitializeComponent();
    ...
    private void EnsureInitialized(UserAccount? currentUser)
    {
        ...
        MedicalRecords.InitializeForAdmin(user, patients, doctors);
        _isInitialized = true;
    }
}
