...
{
    public partial class NursesView : UserControl
    {
        ...
        {
            InitializeComponent();
            Loaded += NursesView_Loaded;
        }

        private void NursesView_Loaded(object sender, RoutedEventArgs e)
        {
            RefreshTables();
        }
        ...
        {
            ActiveNursesGrid.ItemsSource = _dataService.GetActiveNurses()
        ...
        private void RejectNurse_Click(object sender, RoutedEventArgs e)
        {
            ...
            var confirmation = MessageBox.Show(
                $"Reject and remove {nurse.DisplayName}?",
                "Reject Nurse",
