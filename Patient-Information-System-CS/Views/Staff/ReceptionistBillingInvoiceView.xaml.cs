...
{
    public partial class ReceptionistBillingInvoiceView : UserControl
    {
        ...
        public ReceptionistBillingInvoiceView() : this(null)
        {
        }

        public ReceptionistBillingInvoiceView(UserAccount? staffAccount)
        {
            _staffAccount = staffAccount;
            InitializeComponent();
            Loaded += ReceptionistBillingInvoiceView_Loaded;
        }

        private void ReceptionistBillingInvoiceView_Loaded(object sender, RoutedEventArgs e)
        {
            RefreshTables();
        }
        ...
        private void MarkAsPaidButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            MessageBox.Show($"Invoice #{_selectedInvoice.InvoiceId} marked as paid by {staffName}.", "Payment confirmed", MessageBoxButton.OK, MessageBoxImage.Information);
            RefreshTables();
        }
        ...
        private void DownloadInvoiceButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            var dialog = new SaveFileDialog
            {
                ...
                FileName = $"Invoice_{_selectedInvoice.InvoiceId}.pdf",
        ...
        private void DisplayInvoiceDetails(BillingRecord? invoice)
        {
            ...
            InvoiceStatusBadge.Background = invoice.IsPaid ? Brushes.Honeydew : Brushes.MistyRose;
            InvoiceStatusBadge.BorderBrush = invoice.IsPaid ? Brushes.SeaGreen : Brushes.IndianRed;
            InvoiceStatusTextBlock.Foreground = invoice.IsPaid ? Brushes.SeaGreen : Brushes.Firebrick;
            ...
            DaysStayedTextBlock.Text = invoice.DaysStayed == 1 ? "1 day" : $"{invoice.DaysStayed} days";
